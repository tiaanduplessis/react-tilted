...
var Tilt = /*@__PURE__*/(function (PureComponent$$1) {
  function Tilt() {
    var this$1 = this;

    PureComponent$$1.call(this);
  ...
  if ( PureComponent$$1 ) Tilt.__proto__ = PureComponent$$1;
  Tilt.prototype = Object.create( PureComponent$$1 && PureComponent$$1.prototype );
  ...
  Tilt.prototype.render = function render () {
    ...
    var style = ref.style;
    return React.createElement( 'div', { ref: this.ref, className: className, style: style },
        children
      );
  };
